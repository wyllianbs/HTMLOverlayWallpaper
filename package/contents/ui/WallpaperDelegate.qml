...
KCM.GridDelegate {
    ...
    thumbnail: Rectangle {
        ...
        QtControls2.CheckBox {
            // Sempre visível: este plugin é sempre slideshow. Não usar
            // configDialog.currentWallpaper === "org.kde.slideshow" aqui — no
            // contexto do delegate essa propriedade resolve para o id do plugin
            // (io.github.wyllianbs.htmloverlaywallpaper), não "org.kde.slideshow".
            visible: true
